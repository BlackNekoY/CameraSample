...
class SunsetFilter : GPUImageFilter() {

    private val mToneCurveTexture = IntArray(1) {-1}
    private var mMaskGrey1TextureId = -1
    private var mMaskGrey2TextureId = -1

    override fun getFragmentShader(): String {
        return OpenGLUtils.readShaderFromRawResource(R.raw.sunset)
    }
    ...
    override fun onInitialized() {
        ...
        mMaskGrey1TextureId = OpenGLUtils.createTexture2D(BitmapFactory.decodeResource(BaseApplication.getIns().resources, R.drawable.rise_mask1))
        mMaskGrey2TextureId = OpenGLUtils.createTexture2D(BitmapFactory.decodeResource(BaseApplication.getIns().resources, R.drawable.rise_mask2))
    }
    ...
    override fun onPreDraw(textureId: Int, cameraMatrix: FloatArray?, textureMatrix: FloatArray?) {
        ...
        GLES30.glUniform1i(GLES30.glGetUniformLocation(program, "grey1Frame"), 2)

        GLES30.glActiveTexture(GLES30.GL_TEXTURE3)
        GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, mMaskGrey2TextureId)
        GLES30.glUniform1i(GLES30.glGetUniformLocation(program, "grey2Frame"), 3)
    }

    override fun onAfterDraw(textureId: Int, cameraMatrix: FloatArray?, textureMatrix: FloatArray?) {
        super.onAfterDraw(textureId, cameraMatrix, textureMatrix)
        GLES30.glActiveTexture(GLES30.GL_TEXTURE1)
