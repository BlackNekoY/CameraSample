...
class TenderFilter : GPUImageFilter() {

    private var mToneCurveTexture = -1
    private var mMaskGrey1Texture = -1

    override fun getFragmentShader(): String {
        return OpenGLUtils.readShaderFromRawResource(R.raw.tender)
    }
    ...
    override fun onInitialized() {
        ...
        mMaskGrey1Texture = OpenGLUtils.createTexture2D(BitmapFactory.decodeResource(BaseApplication.getIns().resources,R.drawable.bluevintage_mask1))
    }
    ...
    override fun onPreDraw(textureId: Int, cameraMatrix: FloatArray?, textureMatrix: FloatArray?) {
        ...
        GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, mMaskGrey1Texture)
